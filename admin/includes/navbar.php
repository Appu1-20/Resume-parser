<header class="main-header">
  ...
  <a href="#" class="logo">
    ...
    <span class="logo-lg"> <img src="./image/logo.png" alt="Logo" class="brand-image elevation-3"
                    style="max-height: 50px !important"> </span>
  </a>
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown user user-menu">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            ...
            <span class="hidden-xs"><?php echo $admin['uname']; ?></span>
          </a>
